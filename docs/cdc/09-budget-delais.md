...
- **Contingence 20%** : €1,500-2,500 réserve imprévus
- **Paiements échelonnés** : 30% début, 40% milieu, 30% fin
- **Contrats clairs** : Pénalités et conditions définies

#### Délais

- **Buffer 25%** : Extension planning si nécessaire
- **Milestones hebdomadaires** : Suivi progrès régulier
- **Communication transparente** : Alertes risques précoces
...
- **Développement** : Auto-développement vs prestataire
- **Design** : Templates vs création sur mesure
